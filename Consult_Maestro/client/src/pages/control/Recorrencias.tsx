...
function NovoTemplateDialog({
  ...
  const reset = () => {
    setTipo("pagar"); setDescricao(""); setFavorecido(""); setFrequencia("mensal");
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Input value={favorecido} onChange={(e) => setFavorecido(e.target.value)} data-testid="input-template-favorecido" />
          </div>
