...
export default function Orcamento() {
  ...
  // Edições pendentes: chave `${planoContaId}:${mes}` -> string
      ...
      <CardContent>
        {isLoading ? (
          ...
          <Table>
            ...
            <TableBody>
              {data!.linhas.map((l) => (
                <TableRow key={l.planoContaId} data-testid={`row-comparativo-${l.planoContaId}`}>
                  <TableCell className="font-mono text-xs">{l.codigo}</TableCell>
                  <TableCell>{l.conta}</TableCell>
                  <TableCell><Badge variant="outline">{l.natureza}</Badge></TableCell>
